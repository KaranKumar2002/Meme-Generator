...
*/
function clearAll() {
 const isimg=document.querySelector('.meme');
 const isjoke=document.querySelector('.joke');
 const iswisdom=document.querySelector('.wisdom');
 const isriddle=document.querySelector('.riddle');
...
function showJoke() {
  ...
  clearAll();
  document.querySelector('.joke').appendChild(newp);
}
...
function showQuote() {
  ...
  newp1.textContent='- ' + randomQuote.author;
  clearAll();
  document.querySelector('.wisdom').appendChild(newp);
  document.querySelector('.wisdom').appendChild(newp1);
...
function showRiddle() {
  ...
  ans.hidden=true;
  clearAll();
  document.querySelector('.riddle').appendChild(newp);
  document.querySelector('.riddle').appendChild(ans);
